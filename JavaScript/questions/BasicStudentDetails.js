/* 1. Write a Function named (BasicStudentDetails) that
create a new Array of Object {name, email, phone} */
...
// using filter to access single person details


function AccessSinglePerson(name) {
...
function AccessSinglePerson(index) {
...
console.log(AccessSinglePerson(5));

// console.log(AccessSinglePerson("Tushar kumar"));

// console.log(BasicStudentDetails());
